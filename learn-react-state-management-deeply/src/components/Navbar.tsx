      ...
      <nav className="bg-gray-800 mb-5 sticky top-0">
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      isActive
                        ...
                        : "nav-link text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                    }
                    aria-current="page"
                  >
                    Homepage
        ...
        <div className="sm:hidden hidden" id="mobile-menu">
          <div className="space-y-1 px-2 pt-2 pb-3">
            <NavLink
              to="/"
              className="nav-link text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"
            >
              Homepage
            </NavLink>
